...
public sealed record NowPlaying
{
    ...
    [JsonPropertyName("now_playing")] public NowPlayingCurrentSong? CurrentSong { get; set; }

    [JsonPropertyName("playing_next")] public NowPlayingStationQueue? PlayingNext { get; set; }

    [JsonPropertyName("song_history")] public NowPlayingSongHistory[] SongHistory { get; set; } = [];
