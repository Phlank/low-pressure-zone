...
public class GenerateStreamerPassword(UserManager<AppUser> userManager, AzuraCastClient client) : EndpointWithoutRequest<GenerateStreamerPasswordResponse>
{
