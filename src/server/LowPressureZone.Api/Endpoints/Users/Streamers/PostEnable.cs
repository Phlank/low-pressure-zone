...
public class PostEnable(UserManager<AppUser> userManager, IAzuraCastClient azuraCastClient) : EndpointWithoutRequest
{
    public override void Configure()
    {
        Post("/users/{id}/streamers/enable");
    ...
    public override async Task HandleAsync(CancellationToken ct)
    {
        ...
        var updateStreamerResult = await azuraCastClient.EnableStreamerAsync(user.StreamerId.Value);
