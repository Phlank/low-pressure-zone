...
namespace LowPressureZone.Domain.Migrations
{
    ...
    [Migration("20260731070520_AddReleaseEntities")]
    partial class AddReleaseEntities
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LowPressureZone.Domain.Entities.Artist", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("LowPressureZone.Domain.Entities.Release", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("LowPressureZone.Domain.Entities.ReleaseCredit", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("LowPressureZone.Domain.Entities.ReleaseCredit", b =>
                {
                    b.HasOne("LowPressureZone.Domain.Entities.Artist", "Artist")
                        .WithMany("Credits")
                        .HasForeignKey("ArtistId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("LowPressureZone.Domain.Entities.Release", "Release")
                        .WithMany("Credits")
